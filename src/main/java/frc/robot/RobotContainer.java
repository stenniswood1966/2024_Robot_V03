...
public class RobotContainer {
  ...
  private double VerySlowSpeed = TunerConstants.kSpeedAt12VoltsMps / 6; // min speed used during go slow
  ...
  //assign driver joystick buttons to drivetrain functions
    ...
    joystick.leftBumper().whileTrue(drivetrain.applyRequest(() -> drive.withVelocityX(-joystick.getLeftY() * VerySlowSpeed) // Drive forward with negative Y (forward) / 2
